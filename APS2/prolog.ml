...
let rec print_types t = 
	...
	| [] -> print_string("")
        | t::[] -> print_type(t)
	| t::r -> (print_type(t);print_string(",");print_types(r))

and print_type t = 
	match t with 
	|Type(s) -> print_string(s)
        |TypeVec(s, t) -> (print_string("vec("); print_type(t);print_string(")"))
	|TypeFun(q,l) -> (print_string("([");print_types(q);print_string("],");print_type(l); print_string(")"))
...
let rec print_expr e = 
	match e with 
		...
		|Ast.Prim(s,e) -> (print_string("prim(");print_string(s);print_string(",");print_exprs(e);print_string(")"))
...
let rec print_stat s = 
	...
	| SetAps (lval, value) -> (print_string("set("); print_lval(lval);print_string(",");print_expr(value);print_string(")"))
...
and print_lval l = 
  match l with
  |VarVec s -> (print_string("var(");print_string(s);print_string(")"))
  |Nth(lval, expr) -> (print_string("nth(");print_lval(lval);print_string(",");print_expr(expr);print_string(")"))
